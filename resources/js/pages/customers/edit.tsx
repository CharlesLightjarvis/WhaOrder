...
export default function CustomerEdit() {
    ...
    const updateAddress = (
        index: number,
        field: keyof Omit<AddressDraft, 'id' | 'is_default'>,
        value: string,
    ) =>
        setAddresses((prev) =>
            prev.map((address, i) =>
            ...
            <div className="container mx-auto space-y-6 p-4">
                <div className="flex flex-col space-y-2">
                    ...
                    <p className="text-muted-foreground">
                        Modifiez les informations et les adresses du client.
                    </p>
                </div>
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                {
                    title: customer.name ?? customer.whatsapp_number,
                    href: '#',
                },
            ]}
        >
...
CustomerEdit.layout = (page: React.ReactNode) => (
    <CustomerEditLayout>{page}</CustomerEditLayout>
);
